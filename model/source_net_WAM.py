...
class Net(nn.Module):
    def __init__(self, train_size, test_size, is_high, post_processing):
        ...
        self.h_a = h_analysisTransformModel(N, [N, N, N], [1, 2, 2])

        self.h_mean_s = h_synthesisTransformModel(N, [N, N, N], [2, 2, 1])

        self.h_scale_s = h_synthesisTransformModel(N, [N, N, N], [2, 2, 1])
        # 初始化超先验网络的参数
        #
