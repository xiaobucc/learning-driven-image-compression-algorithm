...
def get_parser():
    ...
    parser.add_argument("--last_channels", type=int, default=192, help="Channels of compression feature.")
    ...
    parser.add_argument("--dim_embed", type=int, default=192, help="Dimension of transformer embedding.")
