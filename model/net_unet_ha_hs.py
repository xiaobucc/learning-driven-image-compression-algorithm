...
from .visual_Feature_unet import *
import torch
from torch import nn
...
class Net(nn.Module):
    ...
    def forward(self, inputs, mode='train', num=1):
        ...
        y_shape = z3.shape[2:]
        # image_path = "/media/yang/Pytorch/buxiaobu/code/Neural_Syntax/DDPM/net_unet_ha_hs_0_0067/visual_Feature/ga"
        ...
        # image_path = "/media/yang/Pytorch/buxiaobu/code/Neural_Syntax/DDPM/net_unet_ha_hs_0_0067/visual_Feature/hs_scale"
        # visual_FeatureMap_unet_heat(z_hat, self.h_s, latent_scales.shape[1], image_path,middle_x,down_x1 ,input)
