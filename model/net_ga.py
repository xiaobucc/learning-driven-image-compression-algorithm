...
class Net(nn.Module):
    ...
    def base_params(self):
        ...
        params += self.h_scale_s.parameters()
        params += self.h_mean_s.parameters()
    ...
    def forward(self, inputs, mode='train', num=1):
        ...
        image_path = "/media/yang/Pytorch/buxiaobu/code/Neural_Syntax/DDPM/net_ga/visual_Feature/ga"
        visual_FeatureMap_heat(inputs,self.a_model,z3.shape[1],image_path)
        y_shape = z3.shape[2:]

        z = self.h_a(z3)
        # image_path = "/media/yang/Pytorch/buxiaobu/code/Neural_Syntax/DDPM/net_ga/visual_Feature/ha"
        # visual_FeatureMap_heat(z3,self.h_a,z.shape[1],image_path)
        ...
        latent_scales = self.h_scale_s(z_hat)  # 8 * 320 * 16 * 16
        latent_means = self.h_mean_s(z_hat)  # 8 * 320 * 16 * 16
        image_path = "/media/yang/Pytorch/buxiaobu/code/Neural_Syntax/DDPM/net_ga/visual_Feature/hs"
        visual_FeatureMap_heat(z_hat, self.h_scale_s, latent_scales.shape[1], image_path)
        z3_syntax = z3[:, :self.M, :, :]
