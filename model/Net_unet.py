...
class Net(nn.Module):
    ...
    def forward(self, inputs, mode='train', num=1):
        ...
        if mode == 'train':
            ...
            print("v_mse_1 ",v_mse.item())
            mse = torch.mean((gt - x_hat) ** 2).item()
            print("LIC_mse", mse)
            ...
            print("LIC_psnr", -10 * math.log10(mse))

            msssim = -10 * math.log10(1 - ms_ssim(x_hat, gt, data_range=1.).item())
            print("msssim:",msssim)
