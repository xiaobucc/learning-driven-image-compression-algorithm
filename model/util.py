...
def get_parser():
    ...
    parser.add_argument("--last_channels", type=int, default=96, help="Channels of compression feature.")
    ...
    parser.add_argument("--lr_decay", type=float, default=0.5, help="Learning rate decay. Default=0.75")
    ...
    parser.add_argument("--dim_embed", type=int, default=96, help="Dimension of transformer embedding.")

    parser.add_argument("--depth", type=int, default=6, help="Depth of CiT.")
    parser.add_argument("--heads", type=int, default=3, help="Number of transformer head.")
    ...
    parser.add_argument("--attn_topk", type=int, default=8, help="Top K filter for Self-attention.")
    parser.add_argument("--grad_norm_clip", type=float, default=1.0, help="grad_norm_clip.")
...
class Logger(object):
    ...
    def __init__(self, filename, level='info', when='W0', backCount=3,
